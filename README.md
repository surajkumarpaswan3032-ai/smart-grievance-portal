...
* 📍 Complaint Location Support
* 📎 Evidence Upload
* 💬 Admin Reply System
* 🔍 Track Complaint by Tracking ID
* 🌙 Dark Mode
* 📱 Responsive Design
* 🇮🇳 Indian Government Theme UI
...
```bash
git clone https://github.com/surajkumarpaswan3032-ai/smart-grievance-portal.git
```
...
https://smart-grievance-portal.onrender.com
